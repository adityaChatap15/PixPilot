  ...
  return (
    <div className="m-2">
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              {postedBy?._id === user?.sub && (
                <button
                  ...
                  className="bg-white p-2 opacity-70 hover:opacity-100 text-black font-bold text-dark text-base rounded-3xl hover:shadow-md outline-none"
                >
                  <AiTwotoneDelete />
                </button>
              )}
      ...
      >
        ...
        />
        <p className="font-semibold capitalize">{user?.given_name}</p>
      </Link>
    </div>
  );
};
